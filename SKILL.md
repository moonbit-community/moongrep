...
of a MoonBit project（By default, it scans recursively and skips directories generated by Git and the MoonBit toolchain). 
Specify an *expression pattern* to match with the `--pattern` option. For example, the following
